  ...
  return (
    <div className="grid gap-5">
      ...
      <div className="grid items-start gap-5 lg:grid-cols-2">
        <Card><CardHeader><CardTitle className="flex items-center gap-2"><History className="h-4 w-4 text-indigo-600" />Attempts</CardTitle><CardDescription>Latest first, practice, self tests and tests together.</CardDescription></CardHeader>
